    ...
    <section className="mx-auto xl:container">
      <div className="grid grid-cols-1 px-8 py-8 lg:grid-cols-4">
        <div className="px-2 py-4">
          <h3 className="font-semibold text-blue-700">Our Team</h3>
        ...
        <div className="relative col-span-3">
          ...
          <div
            id="team_container"
            className="scrollbar-none flex gap-12 overflow-x-scroll scroll-smooth whitespace-nowrap px-2 text-ui-600"
          >
            <PersonCard />
            <PersonCard />
            <PersonCard />
